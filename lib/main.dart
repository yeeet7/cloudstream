    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavBar(
        ...
        items: [
          ...
          BottomNavBarItem(PictureIcon('assets/bookmark.png'), onTap: () {setState(() => selected = 2); mainNavKey.currentState?.pushReplacement(MaterialPageRoute(builder: (context) => const Home()));}),
